...
public class LanceurChore implements Lanceur{//créer une instance de cette classe permet de lancer la simulation de la choregraphie en 8
	...
	public void lancement() {
		double dt=0.0001;//en s
		long lastUpdate=System.nanoTime();
		this.s=new Choregraphie2();
